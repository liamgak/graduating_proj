...
def main(c, cell_u_position_info, query_obj, _m):
    ...
    print_format.executor(c, cell_length, cell_u_position_info, query_obj, _m, 3)
    # a=""
    # a = a + c[0] + "\n"
    # b=""
    # total_time=0
    ...
    #             if i==0 or i==1 or i==3 or i==6 or i==9 or i==10 or i==100 or i==1000 or i==10000:
    #                 result=query_processing_algo4(i, l, m, cell_u_position_info, query_obj, _m) #1로 쿼리하면 왜 m=2결과로 나오노!
    ...
    #         b = b +"l: "+str(l)+"\n"
    #         b = b +"m: "+str(m)+"\n"
    #         b = b +"AVG time: "+str(total_time/count)+"\n"
    #         b = b +"Total time: "+str(total_time)+"\n"
    #         b = b +"AVG IO: "+str(IO_count/count)+"\n"
    #         b = b +"TOTAL IO: "+str(IO_count)+"\n"
    #         b = b + "===========\\PARAMETERS\\===========\n"
    #         a = a + b
    #         total_time = 0
    #         count = 0
